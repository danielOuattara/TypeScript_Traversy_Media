...
// type assertion
var cid = 1;
var customerId_0 = cid;
var customerId_1 = cid;
//-------------------------------------
// functions
...
var Person2 = /** @class */ (function () {
    function Person2(person_id, person_name, age) {
        this.id = person_id;
        this.name = person_name;
        this.age = age;
    }
...
var daniel2 = new Person2(1, "Daniel Ouattara", 38);
var julie2 = new Person2(2, "Julie Ouattara");
// daniel2.id = 3; // Error
// daniel2.name = "Gaïa Nihasah"; // Error
daniel2.age = 39;
var Person3 = /** @class */ (function () {
    function Person3(person_id, person_name, age) {
        this.id = person_id;
        this.name = person_name;
        this.age = age;
    }
...
var julie3 = new Person3(1, "Julie Ouattara", 37);
